document.addEventListener("DOMContentLoaded", function () {
  ...
  const commonScrollTrigger = {
    ...
    about: {
      trigger: ".about",
      start: "top bottom",
      scrub: 1.9, //동기화되는 시점이 1.9정도로 지연되게
    },
  };
  ...
  const rotateSquares = gsap.from(gsapSquares, 3, { rotation: 720 });
  ...
  function aboutAnimationWithScroll() {
    ...
    gsap.to(".about_txt", {
      scrollTrigger: commonScrollTrigger.about,
      yPercent: 50, //about 글씨가 스크롤에 따라 0에서 50만큼 내려가는.
    });
  }
